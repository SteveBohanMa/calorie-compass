...
export function FlowStack({ initial, frameless = false }: { initial: FlowScreen; frameless?: boolean }) {
  ...
  const screenWidth = frameless ? window.innerWidth : device.geometry.screen.width;
  ...
  const headerSafeArea = header && !frameless ? device.geometry.safeArea.top : 0;
